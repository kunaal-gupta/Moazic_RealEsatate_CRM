...
export default function Settings() {
  ...
  const users = [
    { id: 'u1', name: 'Kunaal Gupta', email: 'kunaal@Domiq.com', role: 'Super Admin', status: 'active' },
    { id: 'u2', name: 'Jane Doe', email: 'jane@Domiq.com', role: 'Agent', status: 'active' },
    { id: 'u3', name: 'Michael Smith', email: 'michael@Domiq.com', role: 'Agent', status: 'inactive' },
  ];
            ...
            <div className="p-8">
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <p className="text-sm text-slate-500">Manage who has access to RECRM.</p>
                </div>
